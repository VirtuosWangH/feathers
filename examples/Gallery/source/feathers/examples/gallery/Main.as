package feathers.examples.gallery
{
	...
	public class Main extends Sprite
	{
		...
		private static const FLICKR_URL:String = "http://api.flickr.com/services/rest/?method=flickr.interestingness.getList&api_key=" + "9a0554259914a86fb9e7eb014e4e5d52" + "&format=rest";
		...
		protected function loader_completeHandler(event:flash.events.Event):void
		{
			...
			this.fadeTween = new Tween(this.selectedImage, 1, Transitions.EASE_OUT);
